          ...
          <>
            <div className="admin__resumen">
              ...
              <div className="admin__stat">
                ...
                <span className="admin__stat-valor">
                  ${pedidos.length > 0 ? Math.round(totalVentas / pedidos.length).toLocaleString('es-AR') : '0'}
                </span>
              </div>
            </div>
            ...
            {pedidos.length === 0 ? (
              <div className="admin__empty">
                <p>No hay pedidos en ese período.</p>
              </div>
            ) : (
                  ...
                  <tbody>
                    {pedidos.map((p) => (
                      <tr key={p._id} onClick={() => setPedidoDetalle(p)} className="admin__tabla-row">
                        ...
                        <td>
                          <button className="admin__ver-btn">Ver</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
              ...
              <div className="admin__detalle-seccion">
                ...
                {pedidoDetalle.items.map((item, i) => (
                  <div key={i} className="admin__detalle-item">
                    ...
                    <span className="admin__detalle-item-precio">
